...
const Countries = () => {
    ...
    return (
        <div className="my-10">
            ...
            <p className="md:w-4/5 w-full text-center mx-auto mt-3">Embark on a journey through six captivating countries in Europe. From the romantic streets of France to the sun-soaked beaches of Spain, each destination offers a unique blend of history, culture, and natural beauty waiting to be explored.</p>
